...
//   isOpen: boolean;
//   onClose: () => void;
//   onSave: (expenseData: number) => Promise<void>;
// }
...
//     if (expense && isOpen) {
//       setForm({
//         description: expense && 'description' in expense ? expense.description : '',
//         category: expense && 'category' in expense ? expense.category : '',
//         reimbursable: expense && 'reimbursable' in expense ? expense.reimbursable : false,
//         amount: expense && 'amount' in expense ? expense.amount.toString() : '',
//         taxRate: expense && 'taxRate' in expense ? expense.taxRate.toString() : '',
//       });
//     }
//   }, [expense, isOpen]);
...
//           <div>
//             <label className="block text-sm font-medium mb-3 text-gray-200">Description</label>
//             <input 
...
//           <div>
//             <label className="block text-sm font-medium mb-3 text-gray-200">Category</label>
//             <select 
...
//             />
//             <label htmlFor="reimb" className="text-sm font-medium text-gray-200">Reimbursable</label>
//           </div>
          
//           <div className="grid grid-cols-2 gap-4">
//             <div>
//               <label className="block text-sm font-medium mb-3 text-gray-200">Amount (₹)</label>
...
//             </div>
//             <div>
//               <label className="block text-sm font-medium mb-3 text-gray-200">Tax Rate (%)</label>
//               <div className="relative">
...
interface EditExpenseModalProps {
  ...
  isOpen: boolean;
  onClose: () => void;
  onSave: (expenseData: FormState) => Promise<void>;
}
